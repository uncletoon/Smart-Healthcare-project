...
export const Login: React.FC = () => {
  ...
  // Determine where to redirect after login (default to /admin)
  const from = (location.state as any)?.from?.pathname || "/facility-dashboard";
    ...
    <div className="auth-wrapper">
      ...
      <div className="auth-card-container">
        ...
        <div className="navigation-links">
          Don't have an account? <Link to="/facility-dashboard/register">Sign Up</Link>
        </div>
